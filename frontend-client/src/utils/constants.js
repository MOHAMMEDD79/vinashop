...
// API Configuration
export const API_BASE_URL = import.meta.env.VITE_API_URL || 'https://api-v2.vinashop.ps/api';
export const UPLOADS_URL = import.meta.env.VITE_UPLOADS_URL || 'https://api-v2.vinashop.ps';
